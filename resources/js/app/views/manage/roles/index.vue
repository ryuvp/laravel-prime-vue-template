        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable ref="dt" :value="roles" v-model:selection="selectedRoles" dataKey="id"
                    ...
                    <Column field="route" header="Permissions" headerStyle="width:70%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Permissions</span>
                            <span v-for="permission in slotProps.data.permissions" :key="permission">
                                <Tag v-if="permission.name.includes('.')" severity="success">
                                    {{ permission.description }}
                                </Tag>
                                <Tag v-else-if="permission.name.split('.').length > 1" severity="warning">
                                    {{ permission.description }}
                                </Tag>
